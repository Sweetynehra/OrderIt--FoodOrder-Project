...
//from store to check to visulaize from fooditwem
// let fakeCartItems = [
//   {
//     foodItem: {
//       images: [
...
//func pass to btn to trigger to remove the item
 ...
 const deccreaseQty= (id, quantity)=>{
  if(quantity>1){
    const newQty = quantity - 1;
    dispatch(updateCartQuantity(id, newQty, alert))
  }else{
                  ...
                  <div className="row">
                    ...
                    <div className="col-4 col-lg-3 mt-4 mt-lg-0">
                      <div className="stockCounter d-inline">
                        <span className="btn btn-danger minus" onClick={()=> deccreaseQty(item.foodItem, item.quantity)
                        }>-</span>
                        <input
                          type="number"
                        ...
                        <span className="btn btn-primary plus" onClick={()=> increaseQty(
                          // first make arrow func else it will stuck in infinite loop
                          item.foodItem,
                           item.quantity, 
                           item.stock)
                           }>+</span>
